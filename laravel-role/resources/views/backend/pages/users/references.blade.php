                            ...
                            <tbody>
                                @if(!empty($users))
                                    @foreach ($users as $user)
                                        ...
                                        @foreach($user->userReferenceMappings as $referenceUser)
                                    @php
                                        $userDetail = \App\Helpers\Helper::UserDetail($referenceUser->user_id);
                                    @endphp
                                    <tr>
                                            <td>{{ $loop->index+1 }}</td>
                                            ...
                                            <!-- <td></td> -->
                                            {{--<td><a class="btn btn-success text-white" href="{{route('references')}}">Edit</a></td> --}}
                                        {{--  <td>
