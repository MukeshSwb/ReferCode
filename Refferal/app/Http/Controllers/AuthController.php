...
class AuthController extends Controller
{
    ...
    public function postRegistration(Request $request){  
        ...
        $user = User::where('id',$check->id)->update(['refer_code'=>$uniqueReference]);
        $mapping = Helper::UserReferenceMapping($request->referral_code,$check->id);
        if($mapping == false){
            return redirect("/user/dashboard")->withError('Wrong Reference Id');
        }
